...
_SRC  = os.path.join(os.path.dirname(_HERE), "SIEM_V5","src")
...
def _rule_paths():
    ...
    mdir = os.path.join(os.path.dirname(_HERE), "SIEM_V","src","detect","modules")
    return [os.path.join(mdir, f) for f in
...
# ═════════════════════════════════════════════════════════════════════════════
print("\n── 2. bash_sigma ────────────────────────────────────────────────────────")
from detect.modules.bash_sigma import run as bash_run
...
# ═════════════════════════════════════════════════════════════════════════════
print("\n── 3. linux_auditd ──────────────────────────────────────────────────────")
from detect.modules.linux_auditd import run as auditd_run
...
# ═════════════════════════════════════════════════════════════════════════════
print("\n── 4. linux_auth ────────────────────────────────────────────────────────")
from detect.modules.linux_auth import run as auth_run
...
# ═════════════════════════════════════════════════════════════════════════════
print("\n── 5. ransomware_linux ──────────────────────────────────────────────────")
from detect.modules.ransomware_linux import run as rw_run
