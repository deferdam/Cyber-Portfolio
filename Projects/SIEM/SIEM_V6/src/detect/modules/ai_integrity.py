...
from detect.modules.ai_baseline import load_default, load_learned, observe, match_framework
    ...
    for ev in events:
        ...
        if known_hashes and file_hash and file_hash not in known_hashes:
            signals.append(Signal(
                ...
                recommended_actions=["Isoler le service IA immediatement.", "Comparer le hash avec une copie de reference signee.", "Restaurer depuis backup verifie."],
