...
# Correct login -> 200 + cookie. Wait past the minimum inter-attempt spacing (2s)
# first: a human retyping a password takes longer than that anyway, and the whole point
# of the spacing is to slow an immediate automated retry after a failure.
import time
time.sleep(2.1)
