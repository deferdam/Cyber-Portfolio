    ...
    for rule_path in rule_paths:
        ...
        for ev in events:
            ...
            signals.append(Signal(
                ...
                recommended_actions=[
                    "Inspecter ScriptBlockText et décoder si EncodedCommand présent.",
                    "Corréler avec le processus parent et l'activité réseau/fichier ±10 min.",
                    "Vérifier si script admin légitime connu.",
                ],
            ))
